...
-- CreateEnum
CREATE TYPE "TaskStatus" AS ENUM ('TODO', 'IN_PROGRESS', 'SUBMITTED', 'UNDER_REVIEW', 'BLOCKED', 'APPROVED', 'REJECTED');
...
CREATE TABLE "reports" (
    ...
    "reportType" "ReportType" NOT NULL DEFAULT 'DAILY_SITE_REPORT',
...
-- AddForeignKey
ALTER TABLE "materials_used" ADD CONSTRAINT "materials_used_taskId_fkey" FOREIGN KEY ("taskId") REFERENCES "tasks"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
