...
// Components kee kan kanaan dura uumne
...
const DashboardPage = () => {
  return (
    <div className="min-h-screen bg-[#F8F9FB] pb-12">
      ...
      <main className="max-w-[1600px] mx-auto px-8 mt-4">
        ...
        {/* 3. Operational Metrics (Cards afran gubbaa) */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {/* Operational Health (Bar Chart Area) */}
            <section className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm">
              ...
              <div className="h-48 flex items-end justify-between px-6">
                {['ST', 'BR', 'MN', 'WC', 'HP', 'AZ'].map((label, idx) => (
                  <div key={label} className="flex flex-col items-center gap-4 group">
                    ...
                    >
                      <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-white px-2 py-1 rounded shadow-sm border border-slate-100 opacity-0 group-hover:opacity-100 transition-opacity text-[10px] font-bold">
          ...
          <div className="space-y-8">
            ...
            <section className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm">
              ...
              <div className="space-y-4">
                <QueueItem title="HVAC System Refactor" sub="Sub: Marcus Holloway • $22.4k" isUrgent />
                <QueueItem title="Grid Tie-In Verification" sub="Sub: Sara Chen • Ready" />
                <QueueItem title="Exterior Hardscaping" sub="Sub: Leon Vance • Pending Site" />
              </div>
            ...
            <section className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <ReportItem icon={<TrendingUp className="text-blue-500" size={18} />} title="Environmental Compliance Pass" time="5h ago" />
              </div>
            </section>
