...
import Sidebar from '@/components/dashboard/pm/Sidebar'; // Sidebar kee asitti galchi

const DashboardPage = () => {
  return (
    <div className="flex min-h-screen bg-[#F8F9FB]">
      {/* 1. Sidebar (Bitaa irratti) */}
      <div className="hidden lg:block w-72 fixed h-full z-50">
         <Sidebar />
      </div>

      {/* 2. Main Content (Mirga irratti - Sidebar fageenya ml-72 kennaaf) */}
